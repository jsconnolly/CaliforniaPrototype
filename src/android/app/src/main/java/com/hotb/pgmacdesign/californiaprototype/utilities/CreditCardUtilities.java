...
public class CreditCardUtilities {
    ...
    public static enum CardType {
        UNKNOWN,
        VISA(Constants.REGEX_CREDIT_CARD_VISA),
        MASTERCARD(Constants.REGEX_CREDIT_CARD_MASTERCARD),
        AMERICAN_EXPRESS(Constants.REGEX_CREDIT_CARD_AMERICAN_EXPRESS),
        DINERS_CLUB(Constants.REGEX_CREDIT_CARD_DINERS_CLUB),
        DISCOVER(Constants.REGEX_CREDIT_CARD_DISCOVER),
        JCB(Constants.REGEX_CREDIT_CARD_JCB);
