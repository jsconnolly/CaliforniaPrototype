...
import static com.hotb.pgmacdesign.californiaprototype.misc.Constants.TAG_PERMISSIONS_REQUEST_WRITE_EXTERNAL_STORAGE;
...
public class PermissionUtilities {
    ...
    public enum permissionsEnum {
        ...
        WRITE_EXTERNAL_STORAGE("Write External Storage", "Allows the ability to write to external " +
                ...
                MY_PERMISSIONS_REQUEST_WRITE_EXTERNAL_STORAGE, false),
        ...
        DRAW_OVER_SCREENS("Draw Over Screens", "With the new Android software versions, this permission is needed in order to have 2 separate windows up at once. It is required for this app to function properly.",
                Manifest.permission.SYSTEM_ALERT_WINDOW,
                MY_PERMISSIONS_SYSTEM_ALERT_WINDOW, false),
        ;
